...
/**
 * FraudCaseIntermediaryEvaluationResponse
 */
public class FraudCaseIntermediaryEvaluationResponse   {
  private String fraudDecisionReference = null;

  private String intermediaryFraudDecisionAnalysisReference = null;
  ...
  private String intermediaryEvaluationResult = null;
  ...
  **/
  ...
  /**
   * `status: Not Mapped` core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::ISO20022andUNCEFACT::Identifier general-info: \"refers to the action to perform intermediary related fraud decisioing analysis\" 
   * @return intermediaryFraudDecisionAnalysisReference
  **/

  public String getIntermediaryFraudDecisionAnalysisReference() {
    return intermediaryFraudDecisionAnalysisReference;
  }

  public void setIntermediaryFraudDecisionAnalysisReference(String intermediaryFraudDecisionAnalysisReference) {
    this.intermediaryFraudDecisionAnalysisReference = intermediaryFraudDecisionAnalysisReference;
  }
  ...
  **/
   ...
   * @return intermediaryEvaluationResult
  **/

  public String getIntermediaryEvaluationResult() {
    return intermediaryEvaluationResult;
  }

  public void setIntermediaryEvaluationResult(String intermediaryEvaluationResult) {
    this.intermediaryEvaluationResult = intermediaryEvaluationResult;
  }
